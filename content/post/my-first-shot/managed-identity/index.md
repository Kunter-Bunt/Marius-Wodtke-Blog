...
> **Update**: The next section on the Subject Identifier is out of date! With the move to GA, this got changed, check [the official docs](https://learn.microsoft.com/en-us/power-platform/admin/set-up-managed-identity#subject-identifier) for more info! 
